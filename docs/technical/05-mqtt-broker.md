...
| **9001** | MQTT over WebSocket+TLS | όλα τα interfaces | ίδιο password file | Ρυθμισμένη αλλά **δεν χρησιμοποιείται σήμερα** — δες §3 |
...
## 3. Γιατί υπάρχει το 9001 αλλά δεν χρησιμοποιείται
...
Ο listener 9001 παραμένει ενεργός στο `mosquitto.conf` αλλά δεν τον
χρησιμοποιεί κανένα client στο σύστημα σήμερα.
