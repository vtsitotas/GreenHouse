...
// 8-sample average of analogReadMilliVolts(), doubled for the 2×220k divider.
...
void setup() {
  ...
  // Cold boot only: bump boot counter for nonce freshness
